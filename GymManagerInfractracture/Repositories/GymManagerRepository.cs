...
namespace GymManagerInfractracture.Repositories
{
    internal class GymManagerRepository : IGymManagerRepository
    {
        ...
        public void Delete(GymManager gymManager)
        {
            _context.GymManagers.Remove(gymManager);
        }
        ...
        public async Task<GymManager?> GetByIdAsync(int id) 
            => await _context.GymManagers.FindAsync(id);
    }
}
